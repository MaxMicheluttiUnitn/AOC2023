function [resultIsBetter] = isBetterJoker(hand1,hand2)
    ...
    best1_copies=max(values1)+joker1;
    best2_copies=max(values2)+joker2;
    ...
    % check Full Houses
    if best1_copies == 3
        eff_pairs1=sum(values1==2);
        eff_pairs2=sum(values2==2);
        pairs1=0;
        pairs2=0;
        if (joker1==1) && (eff_pairs1==2)
            pairs1=1;
        end
        if (joker2==1) && (eff_pairs2==2)
            pairs2=1;
        end
        if (joker1==2) && (eff_pairs1==1)
            pairs1=1;
        end
        if (joker2==2) && (eff_pairs2==1)
            pairs2=1;
        end
        if (joker1==2) && (eff_pairs1==0)
            pairs1=0;
        end
        if (joker2==2) && (eff_pairs2==0)
            pairs2=0;
        end
        if (joker1==0) && (eff_pairs1==1)
            pairs1=1;
        end
        if (joker2==0) && (eff_pairs2==1)
            pairs2=1;
        end
        if (joker1==0) && (eff_pairs1==0)
            pairs1=0;
        end
        if (joker2==0) && (eff_pairs2==0)
            pairs2=0;
        end
        if pairs1 > pairs2
            resultIsBetter=1;
    ...
    % check double pair
    if best1_copies == 2
        pairs1=sum(values1==2)+joker1;
        pairs2=sum(values2==2)+joker2;
        if pairs1 > pairs2
            resultIsBetter=1;
            return
        end
    ...
    % % if hand1 uses more jokers it loses
    % if (joker1 > 0) && (joker2==0)
    %     resultIsBetter=0;
    %     return
    % end

    % % if hand2 uses more jokers it loses
    % if (joker2 > 0) && (joker1==0)
    %     resultIsBetter=1;
    %     return
    % end
